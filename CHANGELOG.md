...
- Update OpenClaude-compatible plugin metadata, command documentation, and Tool Executor skill guidance.
- Quote command `argument-hint` frontmatter values containing YAML-special characters.
- Preserve upstream package scripts after removing the temporary smoke-test workaround.
